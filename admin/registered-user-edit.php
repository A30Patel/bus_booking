                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title"><b>Edit Registered User</b></h3>
                                             ...
                                             ?>
                                                <div class="form-group">
                                                  <input type="hidden" name="user_id" class="form-control" value="<?php echo $row['id']; ?>">
                                                        ...
                                                        <input type="text" name="name" class="form-control" value="<?php echo $row['name']; ?>"  minlength="3" maxlength="12" placeholder="name" required>
                                                        </div>
